# Requerimientos de usuario — M01 Autenticación

> Lo que pide el usuario, en su lenguaje. Fuente de las historias, no sustituto.
...
| RU-M01-03 | El supervisor no debería poder crear usuarios ni tocar los reportes |
