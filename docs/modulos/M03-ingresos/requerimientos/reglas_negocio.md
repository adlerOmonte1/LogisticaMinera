...
| RN-M03-06 | El correlativo es único, lo asigna el servidor y nunca cambia | Dos ingresos serían indistinguibles como unidad de registro |
...
| RN-M03-09 | Un ingreso no se elimina; se anula con motivo obligatorio y responsable identificado | Se podría depurar el histórico y falsear la cobertura del histórico |
...
## Nota sobre RN-M03-01 y la confiabilidad de la medición

Esta regla no es una preferencia técnica. Es la condición que hace medibles los indicadores de resultado. Si durante la implementación se colapsan ambos campos "para simplificar el formulario", el indicador I1 deja de existir y la dimensión D1 se queda sin medición. Está registrada como decisión D-01 en `../../00-arquitectura/decisiones_diseno.md`.
